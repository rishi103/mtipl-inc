...
export default function Review({ products, formValues }) {
  const payments = [
    { name: 'Card type', detail: 'Visa' },
    { name: 'Card holder', detail: formValues.cardName },
    { name: 'Card number', detail: "xxxx-xxxx-xxxx-"+formValues.cardNumber.substring(8, 12) },
    ...
    <>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={6}>
          ...
          <Typography gutterBottom>{formValues.addressInfo}</Typography>
